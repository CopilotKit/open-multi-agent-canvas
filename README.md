...
> The latest version lives at [`examples/showcases/multi-agent-canvas`](https://github.com/CopilotKit/CopilotKit/tree/main/examples/showcases/multi-agent-canvas).
